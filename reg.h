...
#define USART1_SR	((__REG) (USART2 + 0x00))
#define USART1_DR	((__REG) (USART2 + 0x04))
#define USART1_BRR	((__REG) (USART2 + 0x08))
#define USART1_CR1	((__REG) (USART2 + 0x0C))
#define USART1_CR2	((__REG) (USART2 + 0x10))
#define USART1_CR3	((__REG) (USART2 + 0x14))
#define USART1_GTPR	((__REG) (USART2 + 0x18))
/* USART2 Memory Map */
